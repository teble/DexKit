...
pub fn tools() -> Vec<Tool> {
    vec![
        ...
        tool::<Open,Opened>("open","Open a local APK/DEX under an allowed directory. Keep the source unchanged until open completes; retained DEX bytes are independent afterward. Return an instanceId, input byteLength and dexCount. Close unused instances."),
