...
pub fn tools() -> Vec<Tool> {
    vec![
        ...
        tool::<Open,Opened>("open","Open a local APK/DEX under an allowed directory using Core's path loader. Keep the source file and its path unchanged until close. Return an instanceId, input byteLength and dexCount. Close unused instances."),
