...
def main():
    ...
    parser.add_argument('--mode', choices=['output', 'lookup', 'lookup-prefix', 'lookup-hot', 'interfaces'], required=True)
    ...
    for label, directory in args.variant:
        ...
        if manifest['cmake_options']['DEXKIT_BENCHMARK_DESCRIPTOR_WORKLOAD'] != 'ON':
